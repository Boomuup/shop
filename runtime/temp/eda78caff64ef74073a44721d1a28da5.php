<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"E:\shop\public/../application/admin\view\goods\edit.html";i:1503022720;s:52:"E:\shop\public/../application/admin\view\common.html";i:1502988461;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="padding-big background-color">
    ...
    <div class="tab-content container" style="width: 90%">
         <form action="<?php echo url('admin/goods/update',['id'=>$oldData['gid']]); ?>" method="post">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pid" id="inputID" class="form-control">
                            ...
                            <?php if(is_array($cData) || $cData instanceof \think\Collection || $cData instanceof \think\Paginator): if( count($cData)==0 ) : echo "" ;else: foreach($cData as $key=>$v): ?>
                             <option <?php if($v['cid'] == $oldData['pid']): ?> selected <?php endif; ?> value="<?php echo $v['cid']; ?>"><?php echo $v['_catname']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div>
                        <label>商城价格</label>
                        <input type="text" class="form-control" name="gprice" value="<?php echo $oldData['gprice']; ?>">
                    </div>
                    <div>
                        <label>市场价格</label>
                        <input type="text" class="form-control" name="mprice" value="<?php echo $oldData['mprice']; ?>">
                    </div>
                    <div>
                        <label>商品描述</label>
                        <textarea class="form-control" name="description" cols="30" rows="3 " maxlength="255" placeholder="最长不超过255个字符"><?php echo $oldData['description']; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="input-group">
                                <input type="text" class="form-control" name="atlas" value="<?php echo $oldData['atlas']; ?>" >
                    ...
                    <div class="form-group">
                        <label >商品详情</label>
                        <textarea name="details" id="container" style="height:300px;width:100%;"><?php echo $oldData['details']; ?></textarea>
                        <script>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="input-group">
                                <input type="text" class="form-control" name="cover" readonly value="<?php echo $oldData['cover']; ?>">
                                <div class="input-group-btn">
                                    <button onclick="upImage(this)" class="btn btn-default" type="button">选择图片</button>
                                </div>
                            </div>
                            <div class="input-group" style="margin-top:5px;">
                                <img src="<?php echo $oldData['cover']; ?>" class="img-responsive img-thumbnail" width="150">
                    ...
                    <div class="form-group">
                        <label>查看次数</label>
                        <input type="number" name="click" class="form-control" value="<?php echo $oldData['click']; ?>">
                    </div>
                </div>
            </div>
    ...
    require(['vue'],function (Vue) {
        new Vue({
            ...
            data:{
                ...
                subclass:JSON.parse('<?php echo $oldSub; ?>')
            },
            methods:{
                add(){
                    // id 防止重复
