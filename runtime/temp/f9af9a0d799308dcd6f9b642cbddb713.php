<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\shop\public/../application/admin\view\goods\index.html";i:1502988731;s:52:"E:\shop\public/../application/admin\view\common.html";i:1502988461;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="padding-big background-color">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li ><a href="<?php echo url('admin/goods/create'); ?>">添加/编辑</a></li>
    </ul>
    <hr>
    ...
    <table class="table table-hover">
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$v): ?>
            <tr>
                <td style="line-height: 60px;"><?php echo $v['gid']; ?></td>
                <td style="line-height: 60px;"><?php echo $v['gname']; ?></td>
                <td style="line-height: 60px;"><?php echo $v['gprice']; ?></td>
                <td style="line-height: 60px;"><?php echo $v['mprice']; ?></td>
                <td style="line-height: 60px;"><?php echo $v['click']; ?></td>
                <td style="line-height: 60px;">
                    <img src="<?php echo $v['cover']; ?>" alt="" width="80">
                </td>
                <td style="line-height: 60px;">
                    <a href="<?php echo url('admin/goods/edit',['id'=>$v['gid']]); ?>" class="btn btn-primary btn-xs">编辑</a>
                    <a href='javascript:if(confirm("确定删除吗？")) location.href="<?php echo url('admin/goods/delete',['id'=>$v['gid']]); ?>";' class="btn btn-danger btn-xs">删除</a>
                </td>
            </tr>
