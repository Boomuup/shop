<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\shop\public/../application/home\view\cart\list.html";i:1503276877;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="shopping-cart center bg-fff tc" id="app">
            ...
            <tr data-rec-id="1300777" v-for="(v,k) in cart" >
                <td class="info tl">
                    <a :href="'/goods/'+v['id']+'.html'" target="_blank">
                        <img :src="v['info']['cover']" class="dib m-r-5">
                    </a>
                    <div class="dib">
                ...
                <td>
                    <div class="dib count-box">
                        <a href="javascript:void(0)" @click="reduce(k)" class="icon-bgr icon-sub dib"></a><input type="text" :value="v['num']" class="dib tc icon-number" ><a href="javascript:void(0)" @click="add(k,v['options'][0]['snum'])" class="icon-bgr icon-add dib"></a>
                    </div>
                </td>
        ...
        <div class="cart-btm clear f16">
            ...
            <div class="fr tr">
                ...
                <a href="#" class="btn-red-sml f14 m-l-80 ani-bg">去结账</a>
            </div>
        </div>
    </div>
</div>
