...
<div id="app">
    ...
    <div class="currentloc bg-f5f5f5 clear">
        <div class="center f12">
            <div class="fl"><a href="/">首页</a><span>/</span><?php echo $goodsData['gname']; ?></div>
    ...
    <div class="goods-info bg-fff overhide">
        <div class="center clear m-t-60">
            <div class="img-sm fl m-r-60" id="goods_img_list">
                ...
                <img src="<?php echo $v; ?>" class=" img_id_<?php echo $k; ?>">
                <?php endforeach; ?>
            ...
            <img src="__ZHOME__/picture/ajax-loader.gif"></span>
                ...
                <?php foreach($images as $k=>$v): ?>
                <img src="<?php echo $v; ?>" class="cloudzoom"
            ...
            <div class="goods-attr fr" >
                ...
                <div class="btn-others">
                    <a href="/category/<?php echo $goodsData['pid']; ?>.html"><i class="icon-bgr icon-item m-r-10"></i>查看更多同类商品</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
   let carts = new Vue({
        el:'#app',
        data:{
            goodsData:<?php echo $goodsData; ?>,
            subGoodsData:<?php echo $subGoodsData; ?>,
            goodsnum:0,
            goods:{
                'id':<?php echo $goodsData->gid; ?>,
                'name':'<?php echo $goodsData->gname; ?>',
                'num':1,
                'price':<?php echo $goodsData->gprice; ?>,
                'options':'',
            },
            cart:<?php echo $cart; ?>,
            totalNum : <?php echo $totalNum; ?>,
